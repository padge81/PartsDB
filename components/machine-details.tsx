...
export function MachineDetails({ machineId }: { machineId: string }) {
  const [machine, setMachine] = useState<Machine | null>(null); const [parts, setParts] = useState<Part[]>([]); const [imageUrl, setImageUrl] = useState(""); const [message, setMessage] = useState("Loading machine…");
