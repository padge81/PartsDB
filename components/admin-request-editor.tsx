...
type EditableRequest = { id: string; requested_by: string; part_description: string; part_manufacturer: string; manufacturer_part_number: string; machine_manufacturer: string; machine_name: string; machine_model: string; machine_ids: string[]; supply_type: string; commonly_ordered_part_ids: string[]; supplier_information: SupplierInfo[]; notes: string; review_notes: string; status: string };
...
export function AdminRequestEditor({ requestId }: { requestId: string }) {
  ...
  useEffect(() => {
    ...
    ]).then(async ([requestResult, manufacturerResult, supplierResult, machineResult, partResult, imageResult]) => {
