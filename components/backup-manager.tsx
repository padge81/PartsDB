...
export function BackupManager() {
  ...
  async function runImport(siteMode: SiteMode, changeSiteMode: ChangeSiteMode) {
    ...
    finally { if (siteMode === "maintenance") await changeSiteMode("standby"); setWorking(false); }
  }

  return <AppShell requireAdmin>{(_, siteMode, changeSiteMode) => <main className="workspace backup-workspace"><a className="back-link" href="/admin">← Back to admin</a>
