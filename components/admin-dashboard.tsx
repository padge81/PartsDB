...
export function AdminDashboard() {
  ...
  return <AppShell requireAdmin>{() => <main className="workspace">
    <section className="workspace-heading"><div><p className="eyebrow accent">Administrator portal</p><h1>Review and maintain</h1><p>Protect data quality while keeping technicians moving.</p></div><div className="heading-actions"><a className="button secondary" href="/admin/reference-data">Manage reference data</a><span className="admin-badge"><ShieldIcon/>Administrator</span></div></section>
